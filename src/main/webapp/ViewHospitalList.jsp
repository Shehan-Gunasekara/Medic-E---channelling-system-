...
<body>
  ...
  <main>
	...
	<div class="animate">
        <h1 class="">View hospital account</h1>
        
        <form action="searchViewhos" method="post">
        	<br><br>
        ...
        <c:url value="HospitalAccount.jsp" var="hosDelete">
        	...
        	<c:param name="logoName" value = "${logoName}"/>        	
        		...
        		<div class='four-col-profile hove'>
                     <center>
                          ...
                          <a href = "${hosDelete }"><button class='btn-view-profile'>View Profile</button></a>
                     </center>
                </div>
        </c:forEach>
