...
<body>
  ...
  <main>
	...
	<div class="animate">
        <h1 class="">View doctor account</h1>
        
        <form action="searchViewDoc" method="post">
        	<br><br>
        ...
        <c:url value="DoctorAccount.jsp" var="docDelete">
        	...
        	<c:param name="picName" value = "${picName}"/>        	
        		...
        		<div class='four-col-profile hove'>
                     <center>
                          ...
                          <a href = "${docDelete }"><button class='btn-view-profile'>View Profile</button></a>
                     </center>
                </div>
        </c:forEach>
