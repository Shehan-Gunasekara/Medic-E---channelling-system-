...
<body>
  ...
  <main>
	...
	<div class="animate">
		...
		%>
        <h1 class=""><%=name%> Hospital</h1>
        <form action="UpdateHos"  method="post">
        
        <img src="HospitalLogo/<%=logoName%>"  style='border : px solid #ddd ; border-radius : 60px ; padding : 3px ; width : 150px; height : 150px ;'>
        
        <table width="40%">
        	<tr>
        	
        	<td>Hospital ID   :</td>  <td>  <input type="text" name="HID" value="<%=HID%>" readonly></td><br>
        	</tr>
        	<tr>
        	<td>Name :</td><td> <input type="text" name="Name" value="<%=name%>" ></td>
        	</tr>
        	<tr>
        	<td>Location : </td> <td><input type="text" name="Location" value="<%=Location%>" ></td>
        	</tr>
        	<tr>
		...
		<form action="deletehos"  method="post">
           Press Black Button for delete account<input type="submit" name="submit" value="<%=HID%>" class="deleteBT" >
        </form>
	</div>
    </div>
  </main>
