...
<body>
  ...
  <main>
	...
	<div class="animate">
        ...
        <img src="HospitalLogo/<%=logoName%>"  style='border : px solid #ddd ; border-radius : 60px ; padding : 3px ; width : 150px; height : 180px ;'>
        ...
        <table width="40%">
        	...
        	<tr>
        	<td>Location : </td> <td><input type="text" name="Location" value="<%=Location%>" readonly></td>
        	</tr>
        	<tr>
        	<td>E-Mail: </td><td><input type="email" name="Email" value="<%=email%>" readonly></td>
        	</tr>
        	<tr>
        	<td>Password :</td> <td><input type="password" name="password" id="password" value="<%=password%>" readonly></td>
        	</tr>
        	<tr>
