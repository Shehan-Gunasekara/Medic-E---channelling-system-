...
<body>
  ...
  <main>
	...
	<div class="animate">
        ...
        <img src="DoctorProPic/<%=picName%>"  style='border : px solid #ddd ; border-radius : 60px ; padding : 3px ; width : 150px; height : 170px ;'>
        ...
        <table width="40%">
        	...
        	<tr> 
        	<td>NIC    : </td><td><input type="text" name="NIC" value="<%=NIC%>" readonly></td><br>
        	</tr>
        	<tr>
        	<td>Full Name :</td><td> <input type="text" name="Name" value="<%=name%>" readonly></td>
        	</tr>
        	<tr>
        	<td>Address : </td> <td><input type="text" name="Address" value="<%=address%>" readonly></td>
        	</tr>
        	<tr>
        	...
        	<tr>
        	<td>Specialization : </td> <td> <input type="text" name="Specialization" value="<%=specialization%>" readonly></td>
        	</tr>
