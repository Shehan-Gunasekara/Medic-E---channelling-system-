...
<body>
  ...
  <main>
	...
	<div class="animate">
        <h1 class="">Add hospital account</h1>
        <form action="hos" onsubmit="return checkPassword()" method="post" enctype="multipart/form-data">
        <table width="65%">
        	<tr>
        	
        	<td>Hospital ID </td>  <td>  <input type="text" name="HID"></td><br>
        	</tr>
        	<tr>
        	<td>Hospital Name</td><td> <input type="text" name="Name"></td>
        	</tr>
        	<tr>
