...
<body>
  ...
  <main>
	...
	<div class="animate">
        ...
        <img src="DoctorProPic/<%=picName%>"  style='border : px solid #ddd ; border-radius : 60px ; padding : 3px ; width : 150px; height : 150px ;'>
        
        <table width="40%">
        	<tr>
        	
        	<td>Doctor ID   :</td>  <td>  <input type="text" name="DID" value="<%=DID%>" readonly></td><br>
        	</tr>
        	<tr> 
        	<td>NIC    : </td><td><input type="text" name="NIC" value="<%=NIC%> " ></td><br>
        	</tr>
        	<tr>
        	<td>Full Name :</td><td> <input type="text" name="Name" value="<%=name%>" ></td>
        	</tr>
        	<tr>
        	...
        	<tr>
        	<td>Password :</td> <td><input type="password" name="password1" id="password1" value="<%=password%>" ></td>
        	</tr>
        	<tr>
       		 <td>Phone Number :</td><td> <input type="text" name="phone" value=" <%=phone%>" ></td>
        	</tr>
        	<tr>
        	<td>Specialization : </td> <td> <input type="text" name="Specialization" value="<%=specialization%>" ></td>
        	</tr>
        ...
        <form action="delete"  method="post">
           Press Black Button for delete account<input type="submit" name="submit" value="<%=DID%>" class="deleteBT" >
        </form>
