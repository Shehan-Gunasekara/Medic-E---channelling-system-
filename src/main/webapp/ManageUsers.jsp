  ...
  <main>
	...
	<div class="animate">
        <h1 class="">Manage users</h1>
      	 ...
      	 <a href="AddDoctors.jsp">
        <input type="submit" class="button button1" name="Doctor" value="Add Doctors">
        </a>
        <a href="AddHospital.jsp">
        <input type="submit" class="button button2" name="Hospital" value="Add hospitals">
        </a>
      	
      	<form action="Doctorlist" method="post">
      	
        <input type="submit" class="button button3" name="RemoveDoc" value="Manage Doctors">
        </form>
        
        <form action="HosList" method="post">
        <input type="submit" class="button button4" name="RomoveHos" value="Manage Hospitals">
        </form>
